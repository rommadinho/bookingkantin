...
<body>
    <div class="sidebar">
        <h2>Kantinku</h2>
        <ul>
            <li class="menu"><a href="dashboard_user.php">Menu</a></li>
            <li class="antrian"><a href="antrian_user.php">Antrian</a></li>
            <li class="pesanan"><a href="pesanan_user.php">Pesanan Anda</a></li>
